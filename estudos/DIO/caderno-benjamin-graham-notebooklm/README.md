...
Benjamin Graham (1894–1976) é considerado o pai do **value investing** a filosofia de investir com base no valor real de uma empresa, e não em especulações de mercado. Ele foi professor de Warren Buffett e autor de obras fundamentais como *O Investidor Inteligente* e *Security Analysis*.

Escolhi Benjamin Graham como tema central deste caderno porque meu objetivo é **construir um agente de estudos voltado para o mercado financeiro**, que me ajude a entender como fazer meu dinheiro trabalhar por mim. Mais do que decorar fórmulas, quero absorver a mentalidade e a postura de um dos maiores investidores da história, a forma como ele enxergava o mercado, a disciplina que cultivava e os critérios que usava para tomar decisões.

### Objetivos de Estudo

| # | Objetivo | Descrição |
|---|----------|-----------|
| 1 | **Entender a filosofia do value investing** | Compreender a visão de Graham sobre o que é uma ação, o que determina seu valor real e por que o mercado frequentemente erra no seu apreçamento |
| 2 | **Dominar a Fórmula de Graham** | Aprender a calcular o valor intrínseco de uma ação usando os critérios quantitativos de Graham e saber quando uma ação está "barata" |
| 3 | **Aplicar o conceito de Margem de Segurança** | Entender por que Graham nunca comprava uma ação pelo valor exato calculado e como essa margem protege o investidor de erros e imprevistos |
| 4 | **Absorver a postura do investidor inteligente** | Desenvolver a mentalidade certa: paciência, análise racional, controle emocional e independência em relação às oscilações do mercado |
...
| # | Título | Link | Por que escolhi |
|---|--------|------|-----------------|
| 1 | O Método mais Simples para Comprar Ações Baratas - Benjamin Graham | [Assistir](https://youtu.be/ZxYEKaAeBew?si=6uofSQ-Dpr6YBBR0) | Apresenta de forma acessível os critérios práticos de seleção de ações baratas segundo Graham, ótimo ponto de entrada para iniciantes |
| 2 | O Valor das Ações pela lógica da Fórmula de Ben Graham | [Assistir](https://youtu.be/ap8XmWadSss?si=AUa88Qfo3XchQFI7) | Explica passo a passo a lógica matemática por trás da fórmula de Graham, ideal para entender o "porquê" antes do "como" |
| 3 | Benjamin Graham: Como ganhar DINHEIRO com CARTÃO DE CRÉDITO | [Assistir](https://youtu.be/i8DojHeEZDY?si=GSLKQG5Z5iNNTMJG) | Aborda a visão de Graham sobre dívida e uso inteligente do dinheiro, relevante para entender sua mentalidade financeira ampla |
| 4 | A HISTÓRIA DE BENJAMIN GRAHAM - Autor do Livro "O Investidor Inteligente" | [Assistir](https://youtu.be/9fZ3H1yHb_E?si=OeN8tOhXauAVGcty) | Cobertura biográfica completa: contexto histórico, influências, trajetória e legado — essencial para entender de onde vieram suas ideias |
| 5 | Benjamin Graham - Como o Dinheiro Realmente Funciona: O que Eles Nunca Ensinam | [Assistir](https://youtu.be/HSl1RmDW1BE?si=3D-GKz9nVPtPTkNH) | Traz ensinamentos de Graham sobre funcionamento do dinheiro que não são ensinados nos meios convencionais — visão sistêmica do mercado |
...
Use estes prompts sempre que quiser revisar ou aprofundar o estudo sobre Graham no NotebookLM ou em qualquer IA:

```
# Revisão rápida
"Quais são os 5 pontos mais importantes da filosofia de Benjamin Graham?"

# Teste de aplicação prática
"Com base nos critérios de Graham, como eu avaliaria se uma ação está barata? Me dê um exemplo passo a passo."

# Exploração do conceito-chave
"Explique o conceito de 'Mr. Market' de Benjamin Graham e como ele deve influenciar minhas decisões de investimento."

# Revisão da fórmula
"Qual é a fórmula de Graham para calcular o valor intrínseco e quais dados financeiros eu preciso para aplicá-la?"

# Mentalidade do investidor
"Como Benjamin Graham descreve o comportamento ideal do investidor inteligente diante das oscilações do mercado?"

# Aplicação no Brasil
"Quais adaptações são necessárias para aplicar os critérios de Graham no mercado de ações brasileiro (B3)?"

# Glossário rápido
"Defina em uma frase os seguintes termos: valor intrínseco, margem de segurança, Mr. Market, investidor defensivo."

# Estudo comparativo
"Como os ensinamentos de Benjamin Graham influenciaram Warren Buffett e onde os dois diferem em sua abordagem?"
```
...
Desenvolvido como entrega do desafio de projeto da DIO.  
Tema: **Benjamin Graham e o Value Investing**  
Ferramenta principal: **NotebookLM + Engenharia de Prompts**
